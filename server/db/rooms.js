...
module.exports = {
  createRoom: function(room){
    return new Promise(function(resolve, reject){
      ...
      var db = setup();
      var statement = ('INSERT INTO rooms (room, created_on) VALUES ($data)').replace('$data', ('$value').replace('$value', object.keys(room).map(function(key){ return [key];}).join('", "')));
  ...
  getAllRooms: function(){
    return new Promise(function(resolve, reject){
      var db = setup();
      var statement = 'SELECT * FROM rooms';
